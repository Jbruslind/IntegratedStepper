...
class DRV824X_4PH: public StepperDriver
{
  public:
    ...
    */
    DRV824X_4PH(int ph1A,int ph1B,int ph2A,int ph2B, int en1 = NOT_SET, int en2 = NOT_SET, 
    int nsleep1 = NOT_SET, int nsleep2 = NOT_SET, int nCS = NOT_SET,
    ...
    int nsleep_pin1; //!< nSleep pin number for clearing faults on phase 1
    int nsleep_pin2; //!< nSleep pin number for clearing faults on phase 2

    int nCS; //!< CS pin for Driver SPI
